---
name: oferta
description: Buduje stronę oferty Twoich usług na stronie zbudowanej w kursie "Stwórz stronę z AI" (Next.js, App Router) w Twoim design systemie. Przeprowadza krótki wywiad o tym, co sprzedajesz, dla kogo, w jakich pakietach i z jakim efektem, a potem składa konwertującą podstronę `/oferta` (problem klienta, pakiety, jak to wygląda, dowód, FAQ, jedno CTA). Uruchom, gdy użytkownik mówi "zrób stronę oferty", "stwórz ofertę moich usług", "strona z cennikiem/pakietami", "/oferta". NIE zmyśla cen, wyników ani opinii - braki oznacza [do potwierdzenia].
---
...
4. Jeśli robiłeś kurs - `kontekst/profil.md`, `kontekst/persona.md`, `karty/karta-strategiczna.md`.
